...
-- Thời gian đã tạo: Th12 24, 2019 lúc 06:04 AM
...
(48, 'Tiếng trung', 49, 'publish', '2019-11-27'),
(47, 'Tiếng nhật', 49, 'publish', '2019-11-27'),
(46, 'Tiếng anh', 49, 'publish', '2019-11-27'),
(53, 'Marketing-Bán hàng', 50, 'publish', '2019-12-13'),
(52, 'Nhân vật-Bài học kinh doanh', 50, 'publish', '2019-12-13'),
...
(55, 'Văn học', 'publish', '2019-12-24'),
(50, 'Kinh tế', 'publish', '2019-11-27'),
(49, 'Ngoại ngữ', 'publish', '2019-11-27');
...
(46, 'hoang xuan tung', 'vung tau', '0359458465', 325000, 'confirmed', '2019-12-22'),
(45, 'quach the tuong', 'kien giang', '039456895', 300000, 'successfully', '2019-12-19'),
(42, 'ha huy khoi', 'ho chi minh', '036595328', 237000, 'cancel', '2019-12-16'),
(41, 'nguyen hoang tuan', 'an giang', 'ádsad', 1195000, 'successfully', '2019-12-13'),
(40, 'nguyen mai anh', 'dong nai', '034935945', 691000, 'cancel', '2019-12-13'),
(39, 'le hung phuong', 'quang nam', '0316352632', 265000, 'successfully', '2019-12-13'),
(38, 'le quoc dat', 'ho chi minh', '0359458465', 205000, 'successfully', '2019-12-13'),
(47, 'hoang xuan tung', 'ho chi minh', '0359458465', 400000, 'waiting_confirm', '2019-12-24'),
(48, 'nguyen van thanh', 'ha noi', '0395212229', 260000, 'confirmed', '2019-12-24'),
(49, 'nguyen nhat nam', 'gia lai', '0369427821', 185000, 'confirmed', '2019-12-24'),
(50, 'le bao ngoc', 'binh duong', '0987222351', 142000, 'waiting_confirm', '2019-12-24');
...
(72, 71, 1, 46, 'publish', '2019-12-22'),
(71, 69, 2, 46, 'publish', '2019-12-22'),
(70, 91, 2, 46, 'publish', '2019-12-22'),
(69, 87, 1, 45, 'publish', '2019-12-19'),
(73, 66, 2, 47, 'publish', '2019-12-24'),
(65, 75, 1, 42, 'publish', '2019-12-16'),
(64, 74, 1, 42, 'publish', '2019-12-16'),
(63, 59, 1, 42, 'publish', '2019-12-16'),
(62, 85, 3, 41, 'publish', '2019-12-13'),
(61, 86, 1, 41, 'publish', '2019-12-13'),
(60, 87, 3, 41, 'publish', '2019-12-13'),
(59, 91, 1, 41, 'publish', '2019-12-13'),
(58, 75, 5, 40, 'publish', '2019-12-13'),
(57, 73, 4, 40, 'publish', '2019-12-13'),
(56, 74, 3, 40, 'publish', '2019-12-13'),
(55, 91, 1, 39, 'publish', '2019-12-13'),
(54, 90, 1, 39, 'publish', '2019-12-13'),
(53, 85, 3, 39, 'publish', '2019-12-13'),
(52, 86, 1, 38, 'publish', '2019-12-13'),
(51, 91, 1, 38, 'publish', '2019-12-13'),
(50, 89, 1, 38, 'publish', '2019-12-13'),
(74, 65, 1, 47, 'publish', '2019-12-24'),
(75, 106, 2, 48, 'publish', '2019-12-24'),
(76, 105, 1, 48, 'publish', '2019-12-24'),
(77, 98, 1, 49, 'publish', '2019-12-24'),
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `create_at` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_products1_categories` (`categori_id`)
...
(49, '/detail.php?product_id=91', '877ma4.jpg', 'publish', '2019-12-13'),
(48, '/detail.php?product_id=89', '576ma2.jpg', 'publish', '2019-12-13'),
(50, '/detail.php?product_id=76', '352tau4.jpg', 'publish', '2019-12-13');
...
(15, 'hoangxuantung', 'admin@gmail.com', '123456', 'admin', 'publish', '2019-10-10'),
(45, 'khoi', 'khoi@gmail.com', '123456', 'admin', 'publish', '2019-12-24'),
(44, 'thetuong', 'tuong@gmail.com', '123456', 'admin', 'publish', '2019-12-23');
COMMIT;
