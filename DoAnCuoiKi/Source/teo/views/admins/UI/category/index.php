                    ...
                    <table id="tech-companies-1" class="table  table-striped">
                        ...
                        <?php foreach ($dataSendView['cate_list'] as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/admin/category/edit.php?id=<?php echo $item->id?>" class="btn btn-icon waves-effect waves-light btn-primary m-b-5"> <i class="fa fa-wrench"></i> </a>
                                    <a  href="/pages/admin/category/delete.php?id=<?php echo $item->id?>" class="btn btn-icon waves-effect waves-light btn-danger m-b-5"> <i class="fa fa-remove"></i> </a>
                                </td>
